...
LCDWIKI_KBV display(ILI9486, 40, 38, 39, -1, 41); //model,cs,cd,wr,rd,reset
...
const uint8_t SUPERMON[] PROGMEM = {
...
{    
    if(millis()-time > 1500) {
        toggle = !toggle;
        display.Fill_Rect(cursor_x, cursor_y, CHAR_PAD_X, CHAR_PAD_Y, BLACK);
        time = millis();
